...
// Source: internal/storage/storage.go (interfaces: Storage)
//
// Generated by this command:
//
//	mockgen -destination=internal/mocks/mock_storage.go -package=mocks internal/storage/storage.go Storage
//
